...
Query::Query(std::string& str) : m_instruct{str}
{
    parse_token();
}
...
//################### Create #####################
Create::Create(std::string& str) : Query(str)
{
    if (!isRightSyntax()) {
...
bool Create::isTypeTrue(std::string& str) const
{
...
void Create::addNameToTheDBList()
{
...
Insert::Insert(std::string& str) : QueryIUDS(str)
{
    std::string str1 = "";
...
bool Insert::isPropertyTrue(int index) const
{
    try {
...
Update::Update(std::string& str) : QueryUDS(str)
{
    std::string str1 = "";
...
void Update::helpUpdateDataToTheDB(std::string str)
{
...
//################ Delete ################
Delete::Delete(std::string& str) : QueryUDS(str)
{
    std::string str1 = "";
    if (m_vec.size() == 2) {
        if (!doesSuchDBExist(1, str1)) {
...
void Delete::removFileNameOfDBList()
{
...
Select::Select(std::string& str) : QueryUDS(str)
{
    std::string str1 = "";
    if (!doesSuchDBExist(2, str1)) {
        std::cout << "db does not exist" << std::endl;
...
bool Update::isTypeTrue(int index) const
{
    int indexProperty = -1;
    for (int i = 2; i < m_infoDB.size(); i += 4) {
